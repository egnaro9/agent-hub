...
export default function HarnessWorld() {
  ...
  return (
    <div
      ...
      style={{ perspective: "1300px", background: "radial-gradient(1100px 600px at 30% 10%, #fbbf2414, transparent 55%), radial-gradient(900px 700px at 85% 90%, #22d3ee0e, transparent 60%)" }}
    >
