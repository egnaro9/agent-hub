...
export default function AgentCertlabWorld() {
  ...
  return (
    <div
      ...
      style={{ perspective: "2600px", background: "radial-gradient(1100px 600px at 30% 10%, #38bdf816, transparent 55%), radial-gradient(900px 700px at 85% 90%, #a3e6350c, transparent 60%)" }}
    >
      <motion.div className="absolute inset-0" style={{ rotateX: rx, rotateY: ry, transformStyle: "preserve-3d" }}>
        ...
        <motion.div
          ...
          style={{ left: "68%", top: "23%", x: midX, z: -20, rotateY: -3.1, borderTop: "2px solid #38bdf8", boxShadow: "0 20px 60px rgba(0,0,0,.5)" }}
        >
