    ...
    >
      <motion.div className="absolute inset-0" style={{ rotateX: rx, rotateY: ry, transformStyle: "preserve-3d" }}>
        ...
        <motion.svg
          ...
          style={{ x: backX, z: -200, rotateX: 24, rotateZ: -8, filter: "blur(0.5px) drop-shadow(0 0 18px #a78bfa55)" }}
        >
        ...
        <motion.div
          ...
          style={{ left: "7%", top: "52%", x: midX, z: 30, rotateY: -6, borderTop: "2px solid #a78bfa", boxShadow: "0 20px 60px rgba(0,0,0,.5)" }}
        >
        ...
        <motion.div
          ...
          style={{ left: "70%", top: "14%", x: midX, z: -10, rotateY: -6, borderTop: "2px solid #a78bfa", boxShadow: "0 20px 60px rgba(0,0,0,.5)" }}
        >
        ...
        <motion.div
          ...
          style={{ left: "68%", top: "55%", x: midX, z: 20, rotateY: 7, borderTop: "2px solid #a78bfa", boxShadow: "0 20px 60px rgba(0,0,0,.5)" }}
        >
