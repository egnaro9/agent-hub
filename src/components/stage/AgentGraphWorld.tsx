...
export default function AgentGraphWorld() {
  ...
  return (
    <div
      ...
      style={{ perspective: "1300px", background: "radial-gradient(1100px 600px at 30% 10%, #a78bfa14, transparent 55%), radial-gradient(900px 700px at 85% 90%, #fb71850e, transparent 60%)" }}
    >
