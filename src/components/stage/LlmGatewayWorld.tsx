...
export default function LlmGatewayWorld() {
  ...
  return (
    <div
      ...
      style={{ perspective: "1300px", background: "radial-gradient(1100px 600px at 30% 10%, #34d39914, transparent 55%), radial-gradient(900px 700px at 85% 90%, #fbbf240e, transparent 60%)" }}
    >
