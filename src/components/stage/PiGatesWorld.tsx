...
export default function PiGatesWorld() {
  ...
  return (
    <div
      ...
      style={{ perspective: "1300px", background: "radial-gradient(1100px 600px at 50% 8%, #fb718512, transparent 55%), radial-gradient(900px 700px at 15% 90%, #2dd4bf0d, transparent 60%)" }}
    >
