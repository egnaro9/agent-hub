...
export default function VacProtocolWorld() {
  ...
  return (
    <div
      ...
      style={{ perspective: "2600px", background: "radial-gradient(1100px 600px at 30% 10%, #eab30814, transparent 55%), radial-gradient(900px 700px at 85% 90%, #38bdf80c, transparent 60%)" }}
    >
