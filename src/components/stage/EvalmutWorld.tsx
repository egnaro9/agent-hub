...
export default function EvalmutWorld() {
  ...
  return (
    <div
      ...
      style={{ perspective: "1300px", background: "radial-gradient(1100px 600px at 30% 10%, #a3e63516, transparent 55%), radial-gradient(900px 700px at 85% 90%, #2dd4bf0e, transparent 60%)" }}
    >
