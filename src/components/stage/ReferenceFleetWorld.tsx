...
export default function ReferenceFleetWorld() {
  ...
  return (
    <div
      ...
      style={{ perspective: "1300px", background: "radial-gradient(1100px 600px at 30% 10%, #f9731614, transparent 55%), radial-gradient(900px 700px at 85% 90%, #a3e6350c, transparent 60%)" }}
    >
      <motion.div className="absolute inset-0" style={{ rotateX: rx, rotateY: ry, transformStyle: "preserve-3d" }}>
        ...
        <div className="absolute top-[9%] left-[6%]" style={{ transform: "translateZ(148px)" }}>
          ...
          <div className="mt-5 flex gap-2.5">
            ...
            <a
              href="https://egnaro9.github.io/reference-fleet/"
              target="_blank"
              rel="noopener"
